...
print("tensor entrada ", input_tensor_train)
print("tensor salida ", target_tensor_train)
print("valor tensor entrada ", input_tensor_val)
print("valor tensor target ", target_tensor_val)
